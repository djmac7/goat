...
const ICONS = {
  ...
  bsky: 'M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.908 0 3.08 0 3.768c0 .69.378 5.65.624 6.479.815 2.736 3.713 3.66 6.383 3.364-3.911.578-7.387 2.01-2.829 7.078 5.013 5.19 6.87-1.113 7.822-4.308.953 3.195 2.05 9.271 7.733 4.308 4.267-4.308 1.172-6.5-2.74-7.078 2.67.296 5.568-.628 6.383-3.364.246-.828.624-5.79.624-6.479 0-.689-.139-1.86-.902-2.203-.659-.299-1.664-.621-4.3 1.24C16.046 4.747 13.087 8.686 12 10.8z',
    ...
    <div className="share-modal-backdrop" onClick={onClose}>
      <div className="share-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="Share your player">
        ...
        <div className="share-modal__socials">
          {SOCIALS.map((s) => (
            <button key={s.key} className="social-btn" style={{ '--social': s.bg }} onClick={() => openIntent(s.href(t, u))} aria-label={`Share to ${s.name}`}>
